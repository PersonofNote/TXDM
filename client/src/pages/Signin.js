...
const Signin = ({user, setUser}) => {
    ...
    const setLocalStorage = (data) => {
        localStorage.setItem('PMMUser', JSON.stringify(data));
        setUser(data)
    }
    ...
    const handleLogin = () => {
        setLoading(true);
        if (formValues.companyName && formValues.password){
            ...
            fetch(`${api_url}api/auth/signin`, requestOptions)
                ...
                .then(res => {
                    res.msg.companyId ? setLocalStorage(res.msg) : setMessage(res.msg)
                })
            }catch (err) {
              ...
              <div className="lg:flex lg:flex-wrap g-0">
                  ...
                  <div className="md:p-12 md:mx-6">
                    <div className="text-center">
                      <img
                        ...
                        alt="logo"
                      />
                      <h4 className="text-xl font-semibold mt-1 mb-12 pb-1">Precision Medicine Matrix</h4>
                    </div>
                    {loading ?  <Loader /> : (
                    <form>
                ...
                >
                  <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                    <h4 className="text-xl font-semibold mb-6">Blurb goes here</h4>
                    <p className="text-sm">
